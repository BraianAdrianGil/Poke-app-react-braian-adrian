...
const PokemonDetail = () => {
  ...
  const mainDatesH4Classes = `${getColors(
    pokemonDetailData?.types[0]
  )}  first__main__dates__container__number`;
  ...
  return (
    <div className="detail__layout__container">
      {!pokemonDetailData ? (
        ...
        <>
          <Link to={"/pokedex"} className="detail__goback__button__container">
          ...
          <article className="detail__general__container">
            <div className="main__dates__general__container">
              ...
              <section className="first__main__dates__container">
                <h4 className={mainDatesH4Classes}>#{pokemonDetailData.id}</h4>
